...
namespace DiGi.GIS.UI
{
    public static partial class Create
    {
        ...
        public static Typology.Classes.Typology? Typology_Residential_YearBuiltData_1(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90, double offset = 1)
        {
            ...
            Typology.Classes.Typology result = new("f203c3ff-7051-4635-8d49-50aea03dbfc0", description);
            ...
            foreach (Building2D building2D in building2Ds)
            {
                ...
                string yearBuiltName = "???";
                int yearBuiltIndex = 0;
                ...
                if (building2D.Reference is string reference && !string.IsNullOrWhiteSpace(reference))
                {
                    if (dictionary_YearBuiltData.TryGetValue(reference, out YearBuiltData? yearBuiltData) && yearBuiltData != null)
                    {
                        ...
                        {
                            int year = predictedYearBuilt.Year;
                            if (year <= 2008)
                            {
                                yearBuiltName = "<min, 2008>";
                                yearBuiltIndex = 1;
                            }
                            else if (year <= 2013)
                            {
                                yearBuiltName = "(2008, 2013>";
                                yearBuiltIndex = 2;
                            }
                            else if (year <= 2017)
                            {
                                yearBuiltName = "(2013, 2017>";
                                yearBuiltIndex = 3;
                            }
                            else if (year <= 2021)
                            {
                                yearBuiltName = "(2017, 2021>";
                                yearBuiltIndex = 4;
                            }
                            else
                            {
                                yearBuiltName = "(2021, max>";
                                yearBuiltIndex = 5;
                            }
                        }
                    }
                ...
                if (!Typology.Modify.TryUpdateByName(typology_Building, [yearBuiltIndex], yearBuiltName, "Year Built", out typology_Building) || typology_Building is null)
                {
                    continue;
                }
        ...
        public static Typology.Classes.Typology? Typology_Residential_YearBuiltData_2(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90, double offset = 1)
        {
            ...
            Typology.Classes.Typology result = new("8807107b-5c59-41f6-9d2c-91fd103ef7b0", description);
        ...
        public static Typology.Classes.Typology? Typology_Residential_YearBuiltData_3(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90)
        {
            ...
            Typology.Classes.Typology result = new("2b4f234d-884b-40e6-9d4b-40aa565a6665", description);
        ...
        public static Typology.Classes.Typology? Typology_Residential_YearBuiltData_4(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90, double offset = 1)
        {
            ...
            Typology.Classes.Typology result = new("f7c39a9a-6bbf-43b9-920e-91f5f4682dc4", description);
        ...
        public static Typology.Classes.Typology? Typology_Residential_YearBuiltData_5(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90)
        {
            ...
            Typology.Classes.Typology result = new("e8ef0f82-e927-44ec-8110-e3ad2e720caa", description);
        ...
        public static Typology.Classes.Typology? Typology_NonResidential_YearBuiltData_1(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90, double offset = 1)
        {
            ...
            Typology.Classes.Typology result = new("0a86f38f-199b-4d61-a98d-2f72799ac23c", description);
        ...
        public static Typology.Classes.Typology? Typology_NonResidential_YearBuiltData_2(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90)
        {
            ...
            Typology.Classes.Typology result = new("fe6eaa8f-ec28-4adc-94b4-8ae6d49d318d", description);
        ...
        public static Typology.Classes.Typology? Typology_NonResidential_YearBuiltData_3(GISModelFile? gISModelFile, string? description, double thinnesRatio = 0.90)
        {
            ...
            Typology.Classes.Typology result = new("86f6558e-73f7-47ee-97dc-24f0c8e967e5", description);
