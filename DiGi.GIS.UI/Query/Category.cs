...
namespace DiGi.GIS.UI
{
    public static partial class Query
    {
        ...
        /// <returns>The selected <see cref="DiGi.YOLO.Enums.Category"/>, or <c>null</c> if the weights dictionary is null or empty.</returns>
        public static DiGi.YOLO.Enums.Category? Category(this Dictionary<DiGi.YOLO.Enums.Category, double>? weights, Random? random = null)
        {
            ...
            double current = 0;
            foreach (KeyValuePair<DiGi.YOLO.Enums.Category, double> keyValuePair in weights)
            {
        ...
        /// <returns>The determined <see cref="DiGi.YOLO.Enums.Category"/>, or <c>null</c> if it cannot be determined.</returns>
        public static DiGi.YOLO.Enums.Category? Category(this YOLOConversionOptions? yOLOConversionOptions, Random? random = null)
        {
