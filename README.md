...
**DiGi.GIS.UI** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.UI.Application](DiGi.GIS.UI.Application)** (Path: `DiGi.GIS.UI\DiGi.GIS.UI.Application`)
* **[DiGi.GIS.UI](DiGi.GIS.UI)** (Path: `DiGi.GIS.UI\DiGi.GIS.UI`)
